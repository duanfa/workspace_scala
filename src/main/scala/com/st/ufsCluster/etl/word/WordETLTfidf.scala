...
object WordETLTfidf {
  ...
  def main(args: Array[String]) {
    ...
    sc.parallelize(recipeMapBC.value.toSeq).saveAsTextFile("/user/hadoop/ufsCluster/Dir_recipeMapTop_word_tfidf" + recipTopN)
    sc.parallelize(recipeMapAll.toSeq).saveAsTextFile("/user/hadoop/ufsCluster/Dir_recipeMapAll_word_tfidf" + recipTopN)
    sc.parallelize(recipeTop).saveAsTextFile("/user/hadoop/ufsCluster/Dir_recipeTop_word_tfidf" + recipTopN)
    formatResult.saveAsTextFile("/user/hadoop/ufsCluster/Dir_formatResult_word_tfidf" + recipTopN)
  }
