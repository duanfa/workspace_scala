...
object WordETLPercent {
  ...
  def main(args: Array[String]) {
    ...
    sc.parallelize(recipeMapAll.toSeq).saveAsTextFile("/user/hadoop/ufsCluster/Dir_recipeMapAll_word_percent" + recipTopN)
    sc.parallelize(recipeTop).saveAsTextFile("/user/hadoop/ufsCluster/Dir_recipeTop_word_percent" + recipTopN)
    sc.parallelize(recipeMapBC.value.toSeq).saveAsTextFile("/user/hadoop/ufsCluster/Dir_recipeMapTop_word_percent" + recipTopN)
    formatResult.saveAsTextFile("/user/hadoop/ufsCluster/Dir_formatResult_word_percent" + recipTopN)
  }
